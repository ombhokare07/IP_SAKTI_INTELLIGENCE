...
export function RegulatoryAlertsPage() {
  ...
  const acknowledge = async (id: string) => {
    ...
    try { await api(`/alerts/${id}/acknowledge`, {}); resource.reload(); }
